...
//#2
let config = {
    appid:'5c58dfd0ba084a9daeb556df0c5d4873',
    token:'007eJxTYChdt9PSwcbudo8Nr4P+tR/LWbWakjenTD2nLPjE833ZimAFBtNkU4uUtBSDpEQDC5NEy5TE1CRTU7OUNINk0xQTC3Pjndv3pjUEMjJ0RD1lZmSAQBCfhSE5MSeHgQEAMQgf7A==',
    uid:null,
    channel:'call',
}
...
let joinStreams = async () => {
    ...
    client.on("volume-indicator", function(evt){
        for (let i = 0; evt.length > i; i++){
            ...
            if(volume > 0){
                document.getElementById(`volume-${speaker}`).src = volumeOnIcon;
            }else{
                document.getElementById(`volume-${speaker}`).src = volumeOffIcon;
            }
        }
    });


    // Rest of the joinStreams function...
...
let handleUserLeft = (user) => {
    ...
    //Remove from remote users and remove user's video wrapper
